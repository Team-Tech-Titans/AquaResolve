    ...
    export { collection, addDoc, db, storage, uploadBytes, ref, auth, getAuth, updateProfile, updatePhoneNumber, signInWithEmailAndPassword, initializeApp, getReactNativePersistence, onAuthStateChanged, createUserWithEmailAndPassword, signOut };